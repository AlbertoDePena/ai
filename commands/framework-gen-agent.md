...
Generate a `AGENT.md` file from a `PRD.md` that will guide AGENT Code sessions on a project
...
The word framework in this context means these files: `PRD.md → PLANNING.md → TASKS.md → AGENT.md`

## Framework Maintenance Instructions Before Every Session
- Always read `PLANNING.md`, `TASKS.md`, and the `AGENT.md` file before starting work
...
- Note any architectural decisions or patterns in the `AGENT.md` file

## Before Ending Sessions
- Update the `AGENT.md` file with session summary when prompted
- Flag any inconsistencies between framework files
- Note any lessons learned or patterns discovered

## When Requirements Change
- Update files in this order: `PRD.md → PLANNING.md → TASKS.md → AGENT.md`
